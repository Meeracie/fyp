...
module.exports = {
	data: new SlashCommandBuilder()
		.setName('play-sea')
		.setDescription('Play sea sound music in the voice call'),
	async execute(interaction) {
        ...
        const resource = createAudioResource('./assets/song3.mp3')
        ...
        const start = new MessageEmbed()
            ...
            .setImage('https://i.imgur.com/ckKY2Dk.jpg')
            .setFooter({text: 'Now playing: Melodies By The Sea - BigRicePiano'})
